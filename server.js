...
function second(req, res) { 
  var spawn = require("child_process").spawn; 
  var process = spawn('python',["printing.py", req.query.one, req.query.two, req.query.three, req.query.four, req.query.five, req.query.six, req.query.seven, req.query.eight, req.query.nine, req.query.ten]); 
